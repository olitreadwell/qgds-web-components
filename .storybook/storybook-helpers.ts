...
export const exampleImages = {
  vet: "./src/img/example-01-vet.jpg",
  "working-phone-tablet": "./src/img/example-02-working-phone-tablet.jpg",
  "health-worker": "./src/img/example-03-health-worker.jpg",
  "diver-coral": "./src/img/example-04-diver-coral.jpg",
  "secluded-beach": "./src/img/example-05-secluded-beach.jpg",
  "beach-waves-sunset": "./src/img/example-06-beach-waves-sunset.jpg",
  "couple-beach": "./src/img/example-07-couple-beach.jpg",
  "couple-garden-tablet": "./src/img/example-08-couple-garden-tablet.jpg",
  "adult-with-children": "./src/img/example-09-adult-with-children.jpg",
  decorative: "./src/img/example-10-decorative.jpg",
} as const;
...
export const imageHelper = {
  /** Map of all image paths */
  src: exampleImages,

  /** Lookup image path by 1-based index or string ID (e.g., 1 or "06") */
  ...
  /** Lookup image path by key name (strictly typed) */
